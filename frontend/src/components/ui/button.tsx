...
const buttonVariants = cva(
	'inline-flex min-w-max items-center rounded-md flex-shrink-0 border font-normal focus:outline-none disabled:shadow-none disabled:cursor-not-allowed disabled:opacity-50 cursor-pointer',
	{
		variants: {
			variant: {
