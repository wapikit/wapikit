...
func UseSchema(schema string) {
	...
	DiscountCoupon = DiscountCoupon.FromSchema(schema)
	...
	OrganizationSubscription = OrganizationSubscription.FromSchema(schema)
	Pricing = Pricing.FromSchema(schema)
	PricingPlan = PricingPlan.FromSchema(schema)
	Purchase = Purchase.FromSchema(schema)
