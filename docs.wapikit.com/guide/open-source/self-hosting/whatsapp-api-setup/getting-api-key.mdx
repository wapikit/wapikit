...
**You can checkout the official WhatsApp documentation on how to get a permanent access token [here](https://developers.facebook.com/docs/whatsapp/business-management-api/get-started#1--acquire-an-access-token-using-a-system-user-or-facebook-login)**
