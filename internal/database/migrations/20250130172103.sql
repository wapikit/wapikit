...
CREATE TYPE "public"."OrgRolePermissionEnum" AS ENUM (
...
CREATE TYPE "public"."AiModelEnum" AS ENUM (
  'Mistral',
  'Gpt4o',
  'Gemini1.5Pro',
  'GPT4Mini',
...
-- Create enum type "WhatsAppBusinessAccountVerificationStatus"
CREATE TYPE "public"."WhatsAppBusinessAccountVerificationStatus" AS ENUM ('Verified', 'Unverified');

-- Create enum type "MessageTypeEnum"
CREATE TYPE "public"."MessageTypeEnum" AS ENUM (
  'Text',
  'Image',
  'Video',
  'Audio',
...
CREATE TYPE "public"."CampaignStatusEnum" AS ENUM (
  'Draft',
  'Running',
  'Finished',
  'Paused',
...
CREATE TABLE "public"."Tag" (
  ...
  "OrganizationId" uuid NOT NULL,
  PRIMARY KEY ("UniqueId"),
  CONSTRAINT "UniqueLabel" UNIQUE ("Label"),
...
CREATE TABLE "public"."WhatsappBusinessAccount" (
  ...
  "Status" "public"."WhatsAppBusinessAccountVerificationStatus" NOT NULL,
  PRIMARY KEY ("UniqueId"),
